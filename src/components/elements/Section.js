...
import CustomsBtn from "./CustomsBtn.js";
import videoBg from "../assets/travel.mp4";

const Section = () => {
  return (
    <div className="w-full h-screen flex items-center justify-center static">
      <video src={videoBg} autoPlay loop muted className="object-cover w-full h-screen"></video>
